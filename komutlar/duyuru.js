...
exports.run = (client, message, args) => {
    ...
    if(!message.member.roles.cache.has("905630765910482985")) return message.channel.send(`Bu komutu kullanabilmek için \<@&905630765910482985>\ yetkisine sahip olmasınız.`);
